...
SECRET_KEY = 'django-insecure-cvtvn)5mf93mha!5iz4lq&z8mnscpr_**t2h!h4@rys36)6qeg'
...
# on data set by another middleware that was executed previously
MIDDLEWARE = [
...
# If you don’t define a custom LANGUAGES setting, the site will be available
